                            ...
                            <tbody>
                                @forelse ($sales as $sale)
                                    <tr>
                                        ...
                                        <td class="px-5 py-5 border-b text-sm">Rp
                                            {{ number_format($sale->product->purchase_price ?? 0) }}</td>
                                        <td class="px-5 py-5 border-b text-sm">Rp
                                            {{ number_format($sale->quantity * $sale->price_at_time) }}</td>
                                        <td class="px-5 py-5 border-b text-sm font-bold text-green-600">
                                            Rp
                                            {{ number_format(($sale->price_at_time - $sale->product->purchase_price) * $sale->quantity) }}
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
